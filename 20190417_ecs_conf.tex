...
\begin{frame}[c]{Resultant turnover:\ LPZ}
  \begin{figure}[t]
    \centering
    \resizebox{0.6\textwidth}{!}{\input{99_images/201811221433-75-conns-top-EE-lpz_c_E-in.tex}}\\%
    \resizebox{0.6\textwidth}{!}{\input{99_images/201811221433-75-conns-top-IE-lpz_c_E-in.tex}}\\%
    \resizebox{0.6\textwidth}{!}{\input{99_images/201811221433-05-se-con-post-totals-lpz_c_E.tex}}%
  \end{figure}
\end{frame}
\begin{frame}[c]{Resultant turnover:\ outside LPZ}
  \begin{figure}[t]
    \centering
    \resizebox{0.6\textwidth}{!}{\input{99_images/201811221433-75-conns-top-EE-p_lpz_E-in.tex}}\\%
    \resizebox{0.6\textwidth}{!}{\input{99_images/201811221433-75-conns-top-IE-p_lpz_E-in.tex}}\\%
    \resizebox{0.6\textwidth}{!}{\input{99_images/201811221433-05-se-con-post-totals-p_lpz_E.tex}}
  \end{figure}
\end{frame}
...
\begin{frame}[c]{Resultant turnover:\ pre-synaptic}
  \begin{figure}[!t]
    \centering
    \resizebox{0.6\textwidth}{!}{\input{99_images/201811221433-75-conns-top-EE-p_lpz_E-out.tex}}\\%
    \resizebox{0.6\textwidth}{!}{\input{99_images/201811221433-75-conns-top-IE-lpz_c_I-out.tex}}\\%
    \resizebox{0.6\textwidth}{!}{\input{99_images/201811221433-05-se-con-pre-totals-lpz_c_I-p_lpz_E.tex}}
  \end{figure}
\end{frame}
\begin{frame}[c]{Post-synaptic growth dynamics}
  \begin{columns}
...
\begin{frame}[c]{Post-synaptic dynamics: single neuron stability}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{figure}[h]
        \centering
        \resizebox{\textwidth}{!}{\input{99_images/single-neuron-schematic.tex}}%
      \end{figure}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{figure}[h]
        \centering
        \resizebox{0.9\textwidth}{!}{\input{99_images/single-neuron-calciums.tex}}\\%
        \resizebox{0.9\textwidth}{!}{\input{99_images/single-neuron-inputs-new.tex}}\\%
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
